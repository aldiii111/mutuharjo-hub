...
| `--color-danger` | oklch(0.1931 0.0037 164.6298) | oklch(0.6368 0.2078 25.3313) | Error, validasi gagal, status ditolak |
| `--color-danger-foreground` | oklch(1 0 0) | oklch(1 0 0) | Text pada danger |
| `--color-success` | oklch(0.5098 0.1320 257.5458) | oklch(0.5098 0.1320 257.5458) | Success, notifikasi positif, status terverifikasi |
...
- **Vertical rhythm**: use multiples of `--space-4` (16 px).
...
- **Dark‑mode only** – harus support **both** light & dark.
...
- Respect `prefers‑reduced‑motion` – non‑essential animasi dimatikan.
...
**OKLCH Token Cheat Sheet (Light / Dark)**
...
| `--color-danger` | oklch(0.1931 0.0037 164.6298) | oklch(0.6368 0.2078 25.3313) |
| `--color-danger-foreground` | oklch(1 0 0) | oklch(1 0 0) |
| `--color-success` | oklch(0.5098 0.1320 257.5458) | oklch(0.5098 0.1320 257.5458) |
| `--color-ring` | oklch(0.6112 0.1217 248.9572) | oklch(0.6576 0.1208 252.0832) |

> Seluruh token menggunakan format OKLCH supaya konsisten dengan Tailwind v4 native. Untuk polyfill di browser lama, konversi ke hex sebelum deploy.

## 12. Reference in `ui-context.md`
`ui-context.md` akan merujuk file di atas (`design-system/master.md`) untuk meng‑sync semua tim. Selanjutnya saya akan menulis `ui-context.md` dengan struktur‑12 bagian yang meng‑link ke token‑design di atas.
